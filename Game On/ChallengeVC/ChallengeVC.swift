...
class ChallengeVC: ButtonBarPagerTabStripViewController {
...
//        settings.style.selectedBarBackgroundColor = .white
    ...
    override func viewControllers(for pagerTabStripController: PagerTabStripViewController) -> [UIViewController] {
        let MyChallenge = UIStoryboard(name: "Challenge", bundle: nil).instantiateViewController(withIdentifier: "myChallenge")
        let MyMatches = UIStoryboard(name: "Challenge", bundle: nil).instantiateViewController(withIdentifier: "myMatches")
        let ChallengeInvite = UIStoryboard(name: "Challenge", bundle: nil).instantiateViewController(withIdentifier: "challengeInvites")
        return [MyChallenge, MyMatches, ChallengeInvite]
    }
