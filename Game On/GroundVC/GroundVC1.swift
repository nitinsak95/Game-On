...
class GroundVC1: ButtonBarPagerTabStripViewController {
    ...
    override func viewControllers(for pagerTabStripController: PagerTabStripViewController) -> [UIViewController] {
        let AllGrounds = UIStoryboard(name: "Ground", bundle: nil).instantiateViewController(withIdentifier: "allGrounds")
        let MyGrounds = UIStoryboard(name: "Ground", bundle: nil).instantiateViewController(withIdentifier: "myGrounds")
        return [AllGrounds, MyGrounds]
    }
