...
//        settings.style.selectedBarBackgroundColor = .white
    ...
    override func viewControllers(for pagerTabStripController: PagerTabStripViewController) -> [UIViewController] {
        let Teams = UIStoryboard(name: "Team", bundle: nil).instantiateViewController(withIdentifier: "teams")
        let MyTeam = UIStoryboard(name: "Team", bundle: nil).instantiateViewController(withIdentifier: "myTeam")
        let TeamInvite = UIStoryboard(name: "Team", bundle: nil).instantiateViewController(withIdentifier: "teamInvite")
        return [Teams, MyTeam, TeamInvite]
    }
